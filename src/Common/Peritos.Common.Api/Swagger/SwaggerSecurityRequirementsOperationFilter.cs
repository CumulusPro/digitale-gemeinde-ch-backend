...
{
    /// <summary>
    /// An IOperation Filter to allow swagger gen to understand which methods require the "JWT Bearer Token" auth scheme to function.
    /// </summary>
    /// <remarks>
    /// This applies to swagger documentation generation only; not for actual user auth of any kind.
    /// </remarks>
